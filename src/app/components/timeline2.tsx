    ...
    const data: TimelineYear[] = [
            ...
            events: [
                {
                    ...
                    description: "Encuentro que unió a academias de danza polinésica y agrupaciones, con el fin de bailar una coreografía creada por Mareva Boucheaux, organizadora mundial de este evento. La academia hizo una invitación a ser todos parte de esta gran organización.",  
                    images: [
        ...
        },
        {
            ...
            events: [
                ...
                },
                {
                    ...
                    description:"Encuentro que convocó a más de 40 alumnas, siendo la primera gala de nuestra academia. En aquel entonces contamos con la participación de alumnos a cargo de Mauricio Navarrete.",
                    images: [
        ...
        },
        {
            ...
            events: [
                {
                    month: "Mayo",
                    title: "3er Flashmob 'Ori Tahiti – Versión online",
            ...
            events: [
                {
                    ...
                    description: "Fue la primera vez que participaron estudiantes de diferentes regiones realizando un 'ōte'a creado por ellas. ",
                ...
                },
                {
                    ...
                    description: "Las juezas que evaluaron fueron Makau Foster, Kohai Vahinetapairu y Almarose Moreno. 1° lugar orquesta creación ",
                    images: [
        ...
        },
        {
            ...
            events: [
                ...
                },
                {
                    ...
                    images: [
                        { src: "/vv24-2.jpg", alt: "Festival Vívelo 2024" }
                    ]
                },
                {
                    month: "Diciembre",
            ...
            events: [
                {
                    ...
                    description: "Luego de 8 años de aprendizaje, Te Fare Mo’a abrió su propio estudio en Providencia - Santiago, con nuevos horarios disponibles, lo que significó un importante paso para nosotros como academia. ",
                    images: [
