    ...
    return (
        <section className="text-gray-600 body-font relative bg-black">
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 relative flex items-end justify-start sm:mr-10 p-10">
                    ...
                    <div className="relative z-10 bg-black flex flex-wrap py-6 rounded shadow-md text-white">
                        <div className="lg:w-1/2 px-6">
                            <h2 className="title-font font-semibold text-white tracking-widest text-xs">ADDRESS</h2>
                            <p className="mt-1 text-white">Photo booth tattooed prism, portland taiyaki hoodie neutra typewriter</p>
                        </div>
                ...
                <div className="lg:w-1/3 md:w-1/2 bg-black text-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <button className="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Enviar</button>
