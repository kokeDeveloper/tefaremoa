...
export async function POST(req: Request) {
  ...
  const { name, firstName, lastName, email, phone, nickname, address, city, birthDate, planStartDate, planEndDate, planType, planStatus, password } = body;
